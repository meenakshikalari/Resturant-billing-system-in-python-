...
# This code sets up a Tkinter-based restaurant ordering system with MySQL integration. 
# Users can add items to a cart, apply discounts, and generate PDF bills.
#  It includes database management for bill numbers and order storage. 
# The GUI allows adding items, viewing cart contents, and generating detailed order summaries.
